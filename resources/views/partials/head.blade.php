<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/theme.css') }}?v={{ config('diamond.asset.version') }}" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('css/responsive.css') }}?v={{ config('diamond.asset.version') }}" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}?v={{ config('diamond.asset.version') }}" type="text/css" media="all" />
